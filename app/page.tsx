...
export default async function Home() {
  ...
  const recentVouchers = await prisma.travelVoucher.findMany({
    ...
    select: { id: true, employee: true, date: true, totalAmount: true, createdAt: true }
  })
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <header className="bg-white shadow-md">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-blue-800">GHANA WATER LIMITED</h1>
            <p className="text-gray-600">Ashanti South Region – Travel & Claims Management System</p>
          </div>
        </div>
      </header>
